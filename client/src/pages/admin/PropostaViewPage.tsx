...
export default function PropostaViewPage() {
    ...
    const totalPax = snap.cotacao.paxAdultos + snap.cotacao.paxCriancas + snap.cotacao.paxBebes;
                                                ...
                                                <div className="flex items-center justify-between flex-wrap gap-2">
                                                    <div className="flex items-center gap-3">
                                                        <div>
                                                            ...
                                                            <div className="text-xs text-muted-foreground">{p.origem || p.segmentos[0]?.aeroportoOrigem || ""}</div>
                                                        </div>
