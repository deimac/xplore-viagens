    ...
    createPeca: adminProcedure
      .input(
        z.object({
          ...
          horaChegada: z.string().optional().nullable(),
      ...
      .mutation(async ({ input }) => {
        ...
        return await db.createCwPeca(
          {
            ...pecaData,
            dataSaida: pecaData.dataSaida ?? null,
            horaSaida: pecaData.horaSaida ?? null,
            dataChegada: pecaData.dataChegada ?? null,
            horaChegada: pecaData.horaChegada ?? null,
          ...
          segmentos.map((s) => ({
            ...
            dataChegada: s.dataChegada ?? null,
