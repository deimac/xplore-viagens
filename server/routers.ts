    ...
    create: adminProcedure
      .input(
        z.object({
          ...
          slug: z.string(),
          descricao: z.string(),
          tipoViagem: z.enum(["pacote", "hospedagem"]).optional(),
    ...
    createPeca: adminProcedure
      .input(
        z.object({
          ...
          itemPessoal: z.number().int().min(0).default(1),
          bagagemMao: z.number().int().min(0).default(0),
          bagagemDespachada: z.number().int().min(0).default(0),
          itemPessoalVolta: z.number().int().min(0).default(1),
          bagagemMaoVolta: z.number().int().min(0).default(0),
          bagagemDespachadaVolta: z.number().int().min(0).default(0),
      ...
      .input(
        z.object({
          ...
          patch: z.object({
            ...
            companhias: z.string().optional().nullable(),
            itemPessoal: z.number().int().min(0).optional(),
            bagagemMao: z.number().int().min(0).optional(),
            bagagemDespachada: z.number().int().min(0).optional(),
            itemPessoalVolta: z.number().int().min(0).optional(),
            bagagemMaoVolta: z.number().int().min(0).optional(),
            bagagemDespachadaVolta: z.number().int().min(0).optional(),
            classe: z.string().optional().nullable(),
            origemVolta: z.string().optional().nullable(),
            destinoVolta: z.string().optional().nullable(),
            dataSaidaVolta: z.string().optional().nullable(),
