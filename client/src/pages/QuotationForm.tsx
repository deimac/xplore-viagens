...
export default function QuotationForm() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      {/* Header com Logo */}
      <div className="w-full bg-gradient-to-r from-blue-600 to-blue-700 py-6 px-4 md:px-8 text-center">
        <h1 className="text-white font-light text-lg md:text-xl">Solicitar Orçamento</h1>
      </div>

      {/* Main Content */}
      <div className="flex-1 flex items-center justify-center px-4 md:px-8 py-12">
        <div className="w-full max-w-3xl">
          {/* Container Style like "Explore o mundo" */}
          <div className="bg-muted/30 border border-muted/40 rounded-xl p-6 md:p-8 shadow-sm">
            {/* Header com Botão Voltar */}
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold text-accent">Preencha o Formulário</h2>
                <p className="text-sm text-muted-foreground mt-1">Nos envie suas informações de viagem</p>
              </div>
              <button
                onClick={() => navigate("/")}
