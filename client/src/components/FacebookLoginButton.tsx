    ...
    return (
        <div className="flex justify-center">
            <button
                ...
                className="flex items-center justify-center gap-3 w-full max-w-[300px] px-6 py-3 bg-[#1877F2] hover:bg-[#166FE5] active:bg-[#1565D8] text-white font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            >
                ...
                <span>{isLoading ? 'Conectando...' : 'Continuar com Facebook'}</span>
            </button>
        </div>
    );
}
